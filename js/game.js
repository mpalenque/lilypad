...
import { loadManifest } from './manifest.js?v=43';
import { UI } from './ui.js?v=43';
import { Renderer } from './renderer.js?v=43';
import { startCamera } from './camera.js?v=43';
import { Motion } from './motion.js?v=43';
import { ToyManager } from './toys.js?v=43';
import { Fx } from './fx.js?v=43';
import { Monitor } from './monitor.js?v=43';
